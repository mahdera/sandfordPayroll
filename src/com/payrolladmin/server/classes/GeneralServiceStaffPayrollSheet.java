 ...
 * 
 */
public class GeneralServiceStaffPayrollSheet {
	private long id;
	 ...
	 * 
	 */
	public GeneralServiceStaffPayrollSheet() {
	}
	 ...
	 */
	public GeneralServiceStaffPayrollSheet(long payrollId, long employeeId, float basicSalary,
	 ...
	 * @param modificationDate
	 */
	public GeneralServiceStaffPayrollSheet(long id, long payrollId, long employeeId, float basicSalary,
			float overtime, float retirementPfEr, float allowanceOther,
			float grossSalary, float taxableIncome, float incomeTax,
			float retirementPfErDeduction, float retirementPfEe, float pension,
			float loanPfLoan, float other, float creditAssociation,
	...
	public void save() {
		try {
			String sqlStr = "insert into tbl_general_staff_payroll_sheet values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	public static void delete(long id) {
		try {
			String sqlStr = "delete from tbl_general_staff_payroll_sheet where id = ?";
			PreparedStatement pStmt = DBConnection.getPreparedStatement(sqlStr);
			pStmt.setLong(1, id);
			DBConnection.writeToDatabase(pStmt);
		} catch (Exception e) {
	...
	public static List<GeneralServiceStaffPayrollSheet> getAllGeneralStaffPayrollSheets() {
		List<GeneralServiceStaffPayrollSheet> list = new ArrayList<GeneralServiceStaffPayrollSheet>();
		GeneralServiceStaffPayrollSheet generalServiceStaffPayrollSheet = null;
		try {
			String query = "select * from tbl_general_staff_payroll_sheet order by modification_date desc";
			ResultSet rSet = DBConnection.readFromDatabase(query);
			while(rSet.next()){
				generalServiceStaffPayrollSheet = new GeneralServiceStaffPayrollSheet(rSet.getLong("id"), rSet.getLong("payroll_id"), 
				...
				list.add(generalServiceStaffPayrollSheet);
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	public static GeneralServiceStaffPayrollSheet getGeneralStaffPayrollSheet(long id) {
		GeneralServiceStaffPayrollSheet generalServiceStaffPayrollSheet = null;
		try {
			String query = "select * from tbl_general_staff_payroll_sheet where id = "+id;
			ResultSet rSet = DBConnection.readFromDatabase(query);
			while(rSet.next()){
				generalServiceStaffPayrollSheet = new GeneralServiceStaffPayrollSheet(rSet.getLong("id"), rSet.getLong("payroll_id"), 
						rSet.getLong("employee_id"), rSet.getFloat("basic_salary"), rSet.getFloat("overtime"), 
		...
		return generalServiceStaffPayrollSheet;
	}
	
	public static List<GeneralServiceStaffPayrollSheet> getAllGeneralStaffPayrollSheetsForThisPayroll(long payrollId){
		List<GeneralServiceStaffPayrollSheet> list = new ArrayList<GeneralServiceStaffPayrollSheet>();
		GeneralServiceStaffPayrollSheet generalServiceStaffPayrollSheet = null;
		try {
			String query = "select tbl_general_staff_payroll_sheet.*,tbl_employee.first_name from tbl_general_staff_payroll_sheet,tbl_employee where payroll_id = "+payrollId+" and tbl_employee.id = " +
					"tbl_general_staff_payroll_sheet.employee_id order by first_name, last_name asc";
			ResultSet rSet = DBConnection.readFromDatabase(query);
			while(rSet.next()){
				generalServiceStaffPayrollSheet = new GeneralServiceStaffPayrollSheet(rSet.getLong("tbl_general_staff_payroll_sheet.id"), rSet.getLong("payroll_id"), 
						rSet.getLong("employee_id"), rSet.getFloat("basic_salary"), rSet.getFloat("overtime"), 
						rSet.getFloat("retirement_pf_er"), rSet.getFloat("allowance_other"), rSet.getFloat("gross_salary"), 
						rSet.getFloat("taxable_income"), rSet.getFloat("income_tax"), rSet.getFloat("retirement_pf_er_deduction"), 
						rSet.getFloat("retirement_pf_ee"), rSet.getFloat("pension"), rSet.getFloat("loan_pf_loan"), 
	...
	public static GeneralServiceStaffPayrollSheet getAllGeneralServicePayrollSheetsForThisPayrollAndEmployee(long payrollId,long employeeId){
		GeneralServiceStaffPayrollSheet generalServiceStaffPayrollSheet = null;
		try {
			String query = "select * from tbl_general_staff_payroll_sheet where payroll_id = "+payrollId+" and employee_id = "+employeeId;
			ResultSet rSet = DBConnection.readFromDatabase(query);
			while(rSet.next()){
				generalServiceStaffPayrollSheet = new GeneralServiceStaffPayrollSheet(rSet.getLong("id"), rSet.getLong("payroll_id"), 
						rSet.getLong("employee_id"), rSet.getFloat("basic_salary"), rSet.getFloat("overtime"), 
