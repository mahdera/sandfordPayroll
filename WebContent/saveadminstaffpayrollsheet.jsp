...
<%
	...
	for(int i=1;i<=ctr;i++){
		...
		AdminStaffPayrollSheet adminStaffPayrollSheet = new AdminStaffPayrollSheet(fetchedPayroll.getId(),
		...
		adminStaffPayrollSheet.save();		
		//now update the amount taken and save it back again to the database...
