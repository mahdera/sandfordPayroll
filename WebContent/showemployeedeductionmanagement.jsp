...
<div style="background:#eee">
	<table border="1" width="100%">
		<tr style="font-weight:bolder">
			<td colspan="2">
				Employee Deduction Management: Employee Type Selector Bar
			</td>
		</tr>
		<tr>
	...
	$('#slctemployeetypedropdown').change(function(){
		...
		if(selectedEmployeeType != ''){
			if(selectedEmployeeType == 'International Employee'){
				$('#employeeListDetailDiv').load('showlistofinternationalemployeesfordeductionmanagement.jsp');
			}else if(selectedEmployeeType == 'National Employee'){
				$('#employeeListDetailDiv').load('showlistofnationalemployeesfordeductionmanagement.jsp');
			}
		}else{
