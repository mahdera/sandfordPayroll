	...
	if(payroll != null){
		...
		<table border="0" width="100%">
			...
			<tr>
				...
				<td>
					<a href="#.jsp" onclick="showPayrollSheetForThisPayroll(<%=payroll.getId() %>,'<%=payrollName %>');">View Payroll Sheet</a>
				</td>
			</tr>
		</table>
		<%
...
<script type="text/javascript">
	function showPayrollSheetForThisPayroll(payrollId, payrollName){
		var divId = "payrollSheetDetailDiv";
		$('#'+divId).load('showpayrollsheetforthispayroll.jsp?payrollId='+payrollId+'&payrollName='+payrollName);
	}
</script>