...
<form style="background:#eee">
	<table border="0" width="100%">
		<tr>
			...
			<td>
				<br/>
				<input type="button" value="Generate Pay Slip" id="btngenerate"/>
	...
	$(document).ready(function(){
		...
		$('#btngenerate').click(function(){
			...
			if(payrollMonth != "" && payrollYear != "" && payrollName != ""){
				$('#loadingDiv').show();
				$("#paySlipDetailDiv").load("generatepayslipinformation.jsp?payrollMonth="+payrollMonth+
