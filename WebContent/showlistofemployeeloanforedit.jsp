					...
					while(employeeLoanItr.hasNext()){
						...
						%>
							<tr>
								...
								<td>
									<a href="#.jsp" onclick="showEditFieldsOfThisEmployeeLoan(<%=employeeLoan.getId() %>);">Edit</a>
								</td>
							</tr>
							<%
								String divId = "employeeLoanEditDiv" + employeeLoan.getId();
							%>
							<tr>
								<td colspan="9">
									<div id="<%=divId%>"></div>
...
<script type="text/javascript">
	function showEditFieldsOfThisEmployeeLoan(employeeLoanId){
		var divId = "employeeLoanEditDiv" + employeeLoanId;
		$('#'+divId).load('showeditfieldsofthisemployeeloan.jsp?employeeLoanId='+employeeLoanId);
	}
</script>